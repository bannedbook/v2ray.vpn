...
class GroupFragment : ToolbarFragment(R.layout.layout_group),
    ...
    override fun onMenuItemClick(item: MenuItem): Boolean {
        (requireActivity() as MainActivity).userActionAds()
        when (item.itemId) {
    ...
    inner class GroupHolder(binding: LayoutGroupItemBinding) :
        ...
        fun bind(group: ProxyGroup) {
            ...
            itemView.setOnClickListener { (requireActivity() as MainActivity).userActionAds() }
            ...
            if(proxyGroup.name== VpnEncrypt.vpnGroupName){
                editButton.isGone=true
